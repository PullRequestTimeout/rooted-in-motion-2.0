...
<footer>
	<div class="container">
		...
		<div class="socials">
			<a aria-label="Link to Rooted in Motion Instagram page" href="https://www.instagram.com/rootedinmotion.ca/">
			...
			<a aria-label="Link to Rooted in Motion Facebook page" href="https://www.facebook.com/rooted.in.motion.manualtherapy">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
					<path
...
<style>
	...
	footer a:hover,
	footer a:active {
		color: var(--color-bronze-2, #e59c42);
	}
