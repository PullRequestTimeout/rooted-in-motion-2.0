<section>
	...
	<ul>
		...
		<li>
			<p>
				...
				to Rooted In Motion Osteopathy, Rossland, BC.
			</p>
		</li>
		<li>
			<p>
		...
		<li>
			<p>
				...
				or individuals employed by the Company to facilitate the Service, to provide the Service on behalf of the Company, to perform services related
		...
		<li>
			<p>
				<strong>Website</strong> refers to Rooted In Motion, accessible from
				<a href="https://rootedinmotion.ca/" rel="external nofollow noopener" target="_blank">https://rootedinmotion.ca/</a>
			</p>
		</li>
		<li>
			<p>
	...
	<p>
		Usage Data may include information such as Your Device's Internet Protocol address (e.g. IP address), browser type, browser version, the pages of
		our Service that You visit, the time and date of Your visit, the time spent on those pages, unique device identifiers and other diagnostic data.
	</p>
	<p>
	...
	<ul>
		<li>
			<strong>Cookies or Browser Cookies.</strong> A cookie is a small file placed on Your Device. You can instruct Your browser to refuse all Cookies
			or to indicate when a Cookie is being sent. However, if You do not accept Cookies, You may not be able to use some parts of our Service. Unless you
		...
		<li>
			...
			to as clear gifs, pixel tags, and single-pixel gifs) that permit the Company, for example, to count users who have visited those pages or opened
	...
	<p>
		...
		You go offline, while Session Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <a
	...
	<p>
		...
		use Your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply
	...
	<p>
		Our Service does not address anyone under the age of 13. We do not knowingly collect personally identifiable information from anyone under the age
		of 13. If You are a parent or guardian and You are aware that Your child has provided Us with Personal Data, please contact Us. If We become aware
	...
	<ul>
		<li>
			<p>By email: michelle@rootedinmotion.ca</p>
		</li>
		<li>
			<p>
				By visiting this page on our website: <a href="https://rootedinmotion.ca/contact" rel="external nofollow noopener" target="_blank"
					>https://rootedinmotion.ca/contact</a
				>
			</p>
		</li>
	</ul>
